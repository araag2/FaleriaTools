...
class NavBar {
	...
	static _initElements () {
		...
		this._addElement_li({keyPath: [NavBar._CAT_RULES], page: "quickreference.html", aText: "Quick Reference"});
		this._addElement_li({keyPath: [NavBar._CAT_RULES], page: "variantrules.html", aText: "Optional, Variant, and Expanded Rules"});
		...
		this._addElement_li({keyPath: [NavBar._CAT_PLAYER], page: "races.html", aText: "Races"});
		...
		this._addElement_li({keyPath: [NavBar._CAT_PLAYER], page: "charactercreator.html", aText: "Character Creator"});
		...
		this._addElement_divider({keyPath: [NavBar._CAT_DUNGEON_MASTER]});
		this._addElement_li({keyPath: [NavBar._CAT_DUNGEON_MASTER], page: "crcalculator.html", aText: "CR Calculator"});
